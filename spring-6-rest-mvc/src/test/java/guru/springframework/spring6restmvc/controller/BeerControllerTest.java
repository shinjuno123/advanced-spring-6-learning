...
class BeerControllerTest {
    ...
    void testPatchBeer() throws Exception {
        ...
        given(beerService.patchBearById(any(),any())).willReturn(Optional.of(beer));
        ...
        verify(beerService).patchBearById(uuidArgumentCaptor.capture(), beerArgumentCaptor.capture());
    ...
    void testCreateNewBeer() throws Exception {
        ...
        given(beerService.saveNewBear(any(BeerDTO.class))).willReturn(beerServiceImpl.listBeers(null, null, false, 1, 25).getContent().get(2));
    ...
    void testCreateBeerNullBeerName() throws Exception {
        ...
        given(beerService.saveNewBear(any(BeerDTO.class))).willReturn(beerServiceImpl.listBeers(null, null, false, 1, 25).getContent().get(1));
